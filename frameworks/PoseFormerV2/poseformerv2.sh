...
for filename in $filenames; do
	...
	csv_out=${filename_no_ending/video/csv_poseformerv2}.csv
	...
	python poseformerv2_annotate_data.py -npz $npz -v $filename -time $output_time -out $csv_out
